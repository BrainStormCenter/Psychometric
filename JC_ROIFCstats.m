...
%%          ANALYSIS #1 (T-TEST, HC vs. CLBP [pre, both visits])
...
% stats
    ...
    cond = (['both']);
    Hy = ([h]);
%%          ANALYSIS #2 (T-TEST [HC v CLBP], COMPARING PRE FROM THE NEG VISITS, NOT OVERLY USEFUL)
...
%%           ANALYSIS #3 (T-TEST [HC v CLBP], COMPARING PRE FROM THE POS VISITS, NOT OVERLY USEFUL) 
%   ttest2(group-1, pre/post, neg/post, group-2, pre/post, neg/post)
...
%%           ANALYSIS #4 (T-TEST [HC v CLBP], POST > PRE (NEG), WHAT DID THE NEG MANIPULATION INCREASE)
...
%%           ANALYSIS #5 (T-TEST [HC v CLBP], POST > PRE (POS), WHAT DID THE POS MANIPULATION INCREASE)
...
[h, p, ci, stats] = ttest2(painnet(i1, 2, 2) - painnet(i1, 1, 2), painnet(i2, 2, 2) - painnet(i2, 1, 2), ...
    ...
    %%           ANALYSIS #6 (T-TEST [HC v FM], POST > PRE (NEG), WHAT DID THE NEG MANIPULATION INCREASE)
%   TO TEST GROUP DIFFERENCES IN POST-PRE IN THE NEGATIVE CONDITION
%   THAT IS, GROUP DIFFERENCES IN HOW MUCH THE NEGATIVE MOOD MANIPULATION
%   INCREASED ACTIVITY IN THE ROIs
...
%%           ANALYSIS #7 (T-TEST [HC v FM], POST > PRE (POS), WHAT DID THE POS MANIPULATION INCREASE)
%   TO TEST GROUP DIFFERENCES IN POST-PRE IN THE POSITIVE CONDITION
%   THAT IS, GROUP DIFFERENCES IN HOW MUCH THE POSITIVE MOOD MANIPULATION
%   INCREASED ACTIVITY IN THE ROIs
